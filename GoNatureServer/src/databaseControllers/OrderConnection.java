...
public final class OrderConnection extends AbstractDBConnection {
	...
	/**
	 * Returns all orders of an existing customer.
	 * 
	 * Existing customers are connected to orders by subscriber_id.
	 */
	public List<Order> getUserOrders(Message m) throws SQLException {
		ensureConnection();

		String sql = selectByFields(new String[] { "*" }, new String[] { SUBSCRIBER_ID });
