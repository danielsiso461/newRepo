...
INSERT INTO `guide` VALUES (101,345672184,1,'Galil Tours','active','2026-05-30 17:48:26'),(102,567892341,1,'Nature Kids Group','active','2026-05-30 17:48:26'),(103,764937601,1,'GoNature Organized Trips','revoked','2026-05-30 17:48:26'),(104,456781239,5,'Travelerssss','active','2026-06-25 13:34:13');
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `chk_order_number_of_visitors` CHECK ((`number_of_visitors` between 1 and 15))
) ENGINE=InnoDB AUTO_INCREMENT=777932 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `park` VALUES (1,'Carmel National Park',140,0,15,4,65.00,1,15.00),(2,'Banias Nature Reserve',120,9,20,5,40.00,1,1.00),(3,'Ein Gedi Nature Reserve',130,0,25,6,45.00,1,0.00);
...
INSERT INTO `park_parameter_change_request` VALUES (1,1,'max_capacity','110','140','rejected'),(2,1,'max_capacity','110','140','approved'),(3,1,'max_capacity','110','140','rejected'),(4,1,'max_capacity','110','140','approved');
...
INSERT INTO `waiting_list` VALUES (1,215346467,1,'2028-04-20 00:00:00',3,1,'waiting',NULL,NULL,'2026-05-30 17:58:57'),(2,257218593,2,'2028-04-21 00:00:00',2,2,'waiting',NULL,NULL,'2026-05-30 17:58:57'),(3,789014563,3,'2028-04-22 00:00:00',4,3,'expired','2026-05-30 17:58:57','2026-05-31 17:58:57','2026-05-30 17:58:57'),(4,345672184,2,'2026-07-10 03:00:00',13,1,'confirmed','2026-06-25 13:51:17','2026-06-25 14:51:17','2026-06-25 13:49:41');
...
-- Dump completed on 2026-06-25 21:25:37
